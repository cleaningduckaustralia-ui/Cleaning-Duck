    ...
    <section className="section bg-white relative overflow-hidden" aria-label="Customer testimonials" id="testimonials" ref={ref}>
      ...
      <div className="container-custom">
        <div className="text-center mb-14">
          ...
          <h2 className="section-title mt-2">Trusted by 700+ Happy Clients</h2>
          <p className="section-subtitle mx-auto mt-4">
            Don't just take our word for it — here's what our clients across Brisbane and All over QLD say.
          </p>
          {/* Google rating badge with link */}
          <div className="flex flex-wrap items-center justify-center gap-3 mt-5">
            <a
              href={BRAND.googleReviewsUrl}
              target="_blank"
              rel="noopener noreferrer"
              className="flex items-center gap-2 px-4 py-2 bg-neutral-50 rounded-full border border-neutral-200 hover:border-primary/40 hover:shadow-md transition-all duration-200 group"
            ...
            >
              ...
              <span className="text-sm font-semibold text-neutral-700 group-hover:text-primary transition-colors">5.0</span>
              <div className="stars text-sm text-yellow-400">{'★'.repeat(5)}</div>
              <span className="text-neutral-500 text-sm">· View all reviews</span>
            </a>
          </div>
        </div>
        ...
        {/* Bottom links — View Reviews + Leave a Review */}
        <div className="flex flex-col sm:flex-row items-center justify-center gap-4 mt-6">
          <a
            href={BRAND.googleReviewsUrl}
            target="_blank"
            rel="noopener noreferrer"
            id="view-google-reviews"
            className="inline-flex items-center gap-2 text-sm font-semibold text-primary hover:text-accent transition-colors px-5 py-2.5 rounded-full border border-primary/30 hover:border-accent/50 hover:shadow-md transition-all"
          >
